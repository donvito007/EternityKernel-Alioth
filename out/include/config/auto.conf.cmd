deps_config := \
	...
	drivers/power/xm_power_debug/Kconfig \
	...
	drivers/input/misc/aw8697_haptic_munch/Kconfig \
	drivers/input/misc/aw8697_haptic_new/Kconfig \
...
ifneq "$(KERNELVERSION)" "4.19.286"
include/config/auto.conf: FORCE
endif
ifneq "$(CC_VERSION_TEXT)" "ZyC clang version 17.0.0 (https://github.com/llvm/llvm-project 3da83fbafef1689de1fc45c2c3fa3d258edda09d)"
include/config/auto.conf: FORCE
endif
ifneq "$(srctree)" ".."
include/config/auto.conf: FORCE
...
ifneq "$(CLANG_FLAGS)" "--target=aarch64-linux-android --prefix=/home/donvito/gcc-64/bin/aarch64-linux-android- --gcc-toolchain=/home/donvito/gcc-64  -Wno-misleading-indentation  -Wno-bool-operation -Werror=unknown-warning-option  -Wno-unsequenced"
include/config/auto.conf: FORCE
endif
ifneq "$(SRCARCH)" "arm64"
include/config/auto.conf: FORCE
endif
ifneq "$(CROSS_COMPILE_COMPAT)" "/home/donvito/gcc-32/bin/arm-linux-androideabi-"
include/config/auto.conf: FORCE
endif
ifneq "$(HOSTCXX)" "clang++"
include/config/auto.conf: FORCE
